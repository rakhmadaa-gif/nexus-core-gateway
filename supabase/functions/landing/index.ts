// Nexus Gateway — Landing Page (Supabase Edge Function)
// Serves a static HTML landing page at /functions/v1/landing
...
.service { background: #1a1a1a; border: 1px solid #333; border-radius: 10px; padding: 25px; transition: border-color 0.3s; }
...
.service p { color: #999; font-size: 0.95em; }
...
.method { padding: 3px 10px; border-radius: 5px; font-size: 0.8em; font-weight: 700; margin-right: 15px; min-width: 50px; text-align: center; }
.get { background: #1a3a1a; color: #4ade80; }
.post { background: #3a2a1a; color: #fbbf24; }
.path { font-family: monospace; color: #60a5fa; }
.desc { color: #666; margin-left: auto; font-size: 0.85em; }
...
.code-block code { font-family: 'Fira Code', monospace; font-size: 0.9em; color: #e0e0e0; }
.comment { color: #666; }
...
.breach h4 { color: #fbbf24; margin-bottom: 5px; font-size: 0.95em; }
.breach p { color: #888; font-size: 0.85em; }
...
footer { padding: 30px 0; text-align: center; color: #555; font-size: 0.85em; border-top: 1px solid #222; }
  ...
  <section>
    ...
    <div class="services">
      <div class="service">
        ...
        <div class="price">20 CRED ($0.20)</div>
        <p>Verified JSON schemas for Web3, regulatory compliance, and cross-platform orchestration.</p>
      </div>
      <div class="service">
        <h3>Code Modules</h3>
        <div class="price">120 CRED ($1.20)</div>
        <p>Security-checked Solidity smart contracts — ERC-20, ERC-721, Escrow logic.</p>
      </div>
      <div class="service">
        <h3>Legal-Code Hybrid</h3>
        <div class="price">29,900 CRED ($299.00)</div>
        <p>Bilingual (EN/ID) legal contracts mapped directly to code functions via Digital Twin v3.1.</p>
      </div>
      <div class="service">
        <h3>Pull Payment</h3>
        <div class="price">FREE (adds credits)</div>
        <p>USDC top-up on Polygon via EIP-712 Permit. Auto-converts to CRED. No charge.</p>
      </div>
    </div>
  </section>
...
curl https://xibzsthfrbomefnvbicb.supabase.co/functions/v1/hello-world/samples</code>
    </div>
  </section>
  ...
  <div class="cta">
    ...
    <a href="https://xibzsthfrbomefnvbicb.supabase.co/functions/v1/hello-world/manifest.json" class="btn btn-secondary">Get Manifest</a>
    <a href="https://xibzsthfrbomefnvbicb.supabase.co/functions/v1/hello-world/samples" class="btn btn-secondary">View Samples</a>
  </div>

  <footer>
    <p>Nexus Gateway v4.0.0-frontier — Phase 3 FINAL — FULLY OPERATIONAL</p>
    <p>1 CRED = $0.01 USD · 100 CRED = 1 USDC · MIT License</p>
    <p><a href="https://github.com/rakhmadaa-gif/nexus-core-gateway">GitHub</a> · <a href="https://polygonscan.com/address/0xDEEc5BE05F0911b4aCD7FB6C8a4aa603C13F60e4">PolygonScan</a> · <a href="https://xibzsthfrbomefnvbicb.supabase.co/functions/v1/hello-world/metrics">Live Metrics</a></p>
  </footer>
</div>
</body>
</html>`;
